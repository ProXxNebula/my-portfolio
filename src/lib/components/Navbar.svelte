...
<nav class="navbar" class:scrolled>
  ...
  <div class="nav-container">
    ...
    <div class="nav-actions desktop">
      <ThemeToggle />
      <a href="https://github.com/XORRav" target="_blank" rel="noopener noreferrer" class="nav-cta">
  ...
  <div class="mobile-menu" class:open={mobileMenuOpen}>
    <div class="mobile-menu-content">
      ...
      <a href="https://github.com/XORRav" target="_blank" rel="noopener noreferrer" class="mobile-cta" on:click={closeMobileMenu}>
        <span class="cta-glow"></span>
